...
public class CustomListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        ...
        mHeadView = (LinearLayout) LayoutInflater.from(context).
                inflate(R.layout.fragment_second_lvhead,null);
        // 下拉的小箭头
        ...
        Log.d("CustomListView", "mHeadContentHeight:" + mHeadContentHeight);

        mHeadContentWidth = mHeadView.getMeasuredWidth();
        Log.d("CustomListView", "mHeadContentWidth:" + mHeadContentWidth);
    ...
    private void measureView(View child) {
        ...
        Log.d("CustomListView", "childHeightSpec:" + childHeightSpec);
    ...
    private void changeHeaderViewByState() {
        switch (mState) {
            ...
            case DONE:
                ...
                mProgressBar.setVisibility(GONE);
                mArrowImageView.clearAnimation();
                mArrowImageView.setImageResource(R.mipmap.df);
    ...
    public void setAdapter(ListAdapter adapter) {
        mLastUpdatedTextView.setText("上一次更新时间:" + new Date().toLocaleString());
